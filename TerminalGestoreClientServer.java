 ...
 * 
 */
public class TerminalGestoreClientServer implements Terminal{
    ...
    public TerminalGestoreClientServer(GestoreClientServer gestore){
    ...
    public void main() {
        ...
        do{
            ...
            default:
            //*TODO:
            //trasformare in abstract factory, quindi CommandFactoryGestore factory= CommandFactory.newInstance();
            //factory.getCommand(this.gestore,params)
                CommandFactory<GestoreClientServer> factory = new CommandFactoryGestore();
                try{
