...
public class CommandDeleteClient extends CommandI<GestoreClientServer> implements UndoableCommand{
    ...
    */
    public CommandDeleteClient(GestoreClientServer gestore,String params,Ui ui) throws CommandException {
    ...
    public void execute() throws CommandException {
        try {
            ...
            if(client == null) throw new CommandException("Il server '" + this.getParams() +"' non è stato trovato!");
