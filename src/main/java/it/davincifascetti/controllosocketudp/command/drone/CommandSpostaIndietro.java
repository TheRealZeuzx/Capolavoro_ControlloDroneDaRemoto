...
public class CommandSpostaIndietro implements Command{
 private String params = null;
     ...
     */
    public CommandSpostaIndietro(Client client, String empty,Ui ui) throws CommandException {
        this.params = empty;
        this.ui = ui;
        this.client = client;
    }
    ...
    public void execute() throws CommandException, ErrorLogException{
        new CommandInviaMsgClient(client,"back 1", ui).execute();
    }
}
