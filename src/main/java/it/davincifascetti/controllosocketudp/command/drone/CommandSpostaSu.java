...
public class CommandSpostaSu implements Command{
 private String params = null;
     ...
     */
    public CommandSpostaSu(Client client, String empty,Ui ui) throws CommandException {
        this.params = empty;
        this.ui = ui;
        this.client = client;
    }
    ...
    public void execute() throws CommandException, ErrorLogException{
        new CommandInviaMsgClient(client,"up 1", ui).execute();
    }
}
