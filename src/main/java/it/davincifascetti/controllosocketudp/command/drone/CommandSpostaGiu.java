...
public class CommandSpostaGiu implements Command{
 private String params = null;
     ...
     */
    public CommandSpostaGiu(Client client, String empty,Ui ui) throws CommandException {
        this.params = empty;
        this.ui = ui;
        this.client = client;
    }
    ...
    public void execute() throws CommandException, ErrorLogException{
        new CommandInviaMsgClient(client,"down 1", ui).execute();
    }
}
