...
public class CommandSpostaDestra implements Command{
     ...
     */
    public CommandSpostaDestra(Client client, String empty,Ui ui) throws CommandException {
        this.params = empty;
        this.ui = ui;
        this.client = client;
    }
    ...
    public void execute() throws CommandException, ErrorLogException{
        new CommandInviaMsgClient(client,"right 1", ui).execute();
    }
