...
public class CommandRuotaDestra implements Command{
 private String params = null;
     ...
     */
    public CommandRuotaDestra(Client client, String empty,Ui ui) throws CommandException {
        this.params = empty;
        this.ui = ui;
        this.client = client;
    }
    ...
    public void execute() throws CommandException, ErrorLogException{
        new CommandInviaMsgClient(client,"cw 1", ui).execute();
    }
}
