...
public class CommandSpostaAvanti implements Command{
 private String params = null;
     ...
     */
    public CommandSpostaAvanti(Client client, String empty,Ui ui) throws CommandException {
        this.params = empty;
        this.ui = ui;
        this.client = client;
    }
    ...
    public void execute() throws CommandException, ErrorLogException{
        new CommandInviaMsgClient(client,"forward 1", ui).execute();
    }
}
