...
public class CommandSpostaSinistra implements Command{
 private String params = null;
     ...
     */
    public CommandSpostaSinistra(Client client, String empty,Ui ui) throws CommandException {
        this.params = empty;
        this.ui = ui;
        this.client = client;
    }
    ...
    public void execute() throws CommandException, ErrorLogException{
        new CommandInviaMsgClient(client,"left 1", ui).execute();
    }
}
