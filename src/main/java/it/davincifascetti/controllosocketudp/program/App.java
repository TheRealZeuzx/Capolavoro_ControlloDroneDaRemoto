...
public class App {
    ...
    public App(String errorLogPath,User comandi) throws NullPointerException,CommandableException, CommandException, IOException, ErrorLogException{
        ...
        this.ui = new TerminaleDrone(new ErrorLog(errorLogPath),business,comandi,this);
    }
